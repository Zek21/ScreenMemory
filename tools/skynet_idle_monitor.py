...
SELF_INVOKE_TASK = (
    ...
    "security gaps, performance issues, stale docs. If the issue touches consultants "
    "or dashboard truth, treat Codex Consultant and Gemini Consultant as one shared "
    "integrity check: inspect data/consultant_state.json and data/gemini_consultant_state.json, "
    "then verify http://localhost:8421/consultants, http://localhost:8421/leadership, "
    "http://localhost:8421/dashboard/data, and sender-filtered consultant activity from "
    "http://localhost:8420/bus/messages?limit=30. Do not claim consultant recovery unless "
    "BOTH consultants are represented truthfully together in the dashboard and reporting to Skynet, "
    "or you report the remaining mismatch explicitly. "
