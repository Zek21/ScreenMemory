...
def _kill_tracked_pids():
    """Kill processes from the PID file. Returns count killed."""
    killed = 0
...
def _kill_orphan_processes():
    """Scan and kill orphan processes matching TARGET_SCRIPTS. Returns count killed."""
    killed = 0
...
def main():
    ...
    killed_total = _kill_tracked_pids()

    print("\n[2/3] Scanning for orphan processes...")
    killed_total += _kill_orphan_processes()
